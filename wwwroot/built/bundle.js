...
var EventBus = (function () {
    ...
    EventBus.prototype.send = function (event, data) {
        var topic = EventBus.callbacks[event];
        if (topic !== undefined) {
            console.log("count " + topic.length);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_vueTable__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_property_decorator__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_eventBus__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_http_service__ = __webpack_require__(28);
...
var Rooms = (function (_super) {
    ...
    function Rooms() {
        ...
        _this.columnTitles = {
            ...
            titles: ['Name', 'AirCondition', 'Temperature', 'NodeAddress']
        };
        _this.room = { Name: '', NodeAddress: '', ID: undefined };
        _this.rest = new __WEBPACK_IMPORTED_MODULE_4__services_http_service__["a" /* default */]("http://localhost:5001/api/Rooms");
        _this.eventBus = new __WEBPACK_IMPORTED_MODULE_3__services_eventBus__["a" /* default */]();
        return _this;
    }
    Rooms.prototype.selectedRoomChanged = function (room) {
        this.setSelectedRoom(room);
    };
    Rooms.prototype.loadData = function () {
        console.log(this.dataItems);
        this.rest.get(this.dataItems);
    };
    Rooms.prototype.activated = function () {
        this.loadData();
    };
    Rooms.prototype.addRoom = function () {
        this.rest.add(this.room);
    };
    ...
    Rooms.prototype.showRoom = function () {
        console.log(this.room.Name);
    };
    Rooms.prototype.setSelectedRoom = function (room) {
        this.room = jQuery.extend({}, room);
    };
    Rooms.prototype.onRouteChanged = function (route) {
        var id = Number(route.params.roomID);
        if (id != NaN) {
            this.setSelectedRoom(this.dataItems[id]);
        }
    };
    return Rooms;
}(__WEBPACK_IMPORTED_MODULE_0_vue___default.a));
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vue_property_decorator__["Watch"])('$route')
...
Rooms = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vue_property_decorator__["Component"])({
        ...
        components: { 'vue-table': __WEBPACK_IMPORTED_MODULE_1__components_vueTable__["a" /* default */] }
    })
], Rooms);
...
var Vue = _interopDefault(__webpack_require__(1));
var VueClassComponent = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rooms_rooms__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_eventBus__ = __webpack_require__(3);
...
var eventBus = new __WEBPACK_IMPORTED_MODULE_4__services_eventBus__["a" /* default */]();
eventBus.subscribe('test', function (data) {
    console.log(__filename);
    console.log(data);
});
eventBus.send('test', { 'test': 'Hello World' });
...
var room = new __WEBPACK_IMPORTED_MODULE_3__rooms_rooms__["a" /* default */]();
var routes = [
    { path: '/foo', component: Foo },
    { path: '/Rooms/:roomID?', component: __WEBPACK_IMPORTED_MODULE_3__rooms_rooms__["a" /* default */] }
];
...
var VueTable = (function (_super) {
    __extends(VueTable, _super);
    function VueTable() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.sortOrder = {};
        _this.sortColumn = '';
        _this.page = 1;
        _this.count = _this.dataItems !== undefined ? _this.dataItems.length : 0;
        _this.columns = _this.columnTitles !== undefined ? _this.columnTitles.columns : [];
        _this.titles = _this.columnTitles !== undefined ? _this.columnTitles.titles : [];
        return _this;
    }
    VueTable.prototype.sortBy = function (column) {
        var _this = this;
        ...
        this.dataItems.sort(function (a, b) {
            a = a[column];
            b = b[column];
            return (a === b ? 0 : a > b ? 1 : -1) * _this.sortOrder[column];
        });
    };
    ;
    VueTable.prototype.nextPage = function () {
        this.page = this.pageCount >= (this.page + 1) ? this.page + 1 : this.page = 1;
    };
    ;
    VueTable.prototype.prevPage = function () {
        this.page = this.page < 2 ? this.pageCount : this.page - 1;
    };
    ;
    VueTable.prototype.clickCell = function (row, column) {
        this.selectedChanged(row);
    };
    ;
    Object.defineProperty(VueTable.prototype, "pageCount", {
        get: function () {
    ...
    ;
    Object.defineProperty(VueTable.prototype, "filtered", {
        get: function () {
            var _this = this;
            var filterdArray = [];
            if (this.filter === '') {
                filterdArray = this.dataItems;
            }
            else {
                filterdArray = this.dataItems.filter(function (item) {
            ...
            this.count = filterdArray.length;
            return filterdArray.slice((this.page - 1) * this.pageSize, (this.page) * this.pageSize);
            ;
        },
        enumerable: true,
        configurable: true
    ...
    ;
    VueTable.prototype.selectedChanged = function (item) {
...
/* harmony default export */ __webpack_exports__["a"] = (VueTable);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {var HttpService = (function () {
    ...
    HttpService.prototype.get = function (items) {
        this.ajax('GET', function (data) { data.forEach(function (element) { items.push(element); }); });
    };
    HttpService.prototype.add = function (item) {
        this.ajax("POST", null, null, JSON.stringify(item));
    };
    HttpService.prototype.update = function (item) {
        // put
    };
    HttpService.prototype.delete = function (item) {
        // delete
    };
    return HttpService;
}());
